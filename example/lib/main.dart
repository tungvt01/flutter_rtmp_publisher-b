...
class _CameraExampleHomeState extends State<CameraExampleHome>
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        IconButton(
          ...
          color: Colors.blue,
          onPressed: () {
            controller.addTextOverlay(text: 'Degpeg', size: 60, color: 1);
          },
        ),
        IconButton(
  ...
  Future<List<String>> startVideoStreaming() async {
    await stopVideoStreaming();
    if (controller == null) {
      return null;
    }
    ...
    try {
      // url = myUrl;
      await controller.startVideoStreaming(myUrl, androidUseOpenGL: null);
    } on CameraException catch (e) {
      _showCameraException(e);
      return null;
    }
